...
class _TabsState extends State<Tabs> {
  ...
  final ValueNotifier<bool> _isDarkMode = ValueNotifier(false); // El estado del tema AHORA está aquí
  ...
  void _toggleTheme() { // Función para cambiar el tema
    setState(() {
  ...
  static const List<Widget> _widgetOptions = <Widget>[
    ...
    Text('Index 1: Ubicaciones'),
    Text('Index 2: Colecciones'),
    Text('index 3: Refugio'),
    Text('Index 4: Castillo'),
    Text('Index 5: 360'),
  ];
  @override
  Widget build(BuildContext context) {
     return ValueListenableBuilder<bool>( // Escucha los cambios en _isDarkMode
       ...
       builder: (context, isDarkMode, child) {
             ...
             body: Builder(
               builder: (BuildContext context) {
                 return IndexedStack(
                   ...
                   children: [
                     Principal(isDarkMode: _isDarkMode, toggleTheme: _toggleTheme),
                     Mapa(isDarkMode: _isDarkMode, toggleTheme: _toggleTheme),
                     Colecciones(isDarkMode: _isDarkMode, toggleTheme: _toggleTheme),
                     Refugio(isDarkMode: _isDarkMode, toggleTheme: _toggleTheme),
                     Castillo(isDarkMode: _isDarkMode, toggleTheme: _toggleTheme),
                     WebViewPage(url: 'https://360.amuraone.com/virtualtour/5f1f3688', isDarkMode: _isDarkMode, toggleTheme: _toggleTheme),
                   ],
                 );
               },
             ),
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          backgroundColor: isDarkMode? Colors.black : Colors.white,//Usa el dark mode aqui tambien
